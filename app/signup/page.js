...
export default function SignupPage() {
  ...
  // Remove role state - all users are property_seeker by default
    ...
    <div className="min-h-screen flex flex-col bg-[#f3f4f6]">
      ...
      <div className="flex-grow flex items-center justify-center px-4 py-8">
        <div className="bg-white rounded-lg shadow-lg w-full max-w-md p-8">
          ...
          {message && (
            <div className="mb-6 p-4 bg-green-100 text-green-700 rounded flex items-start">
          ...
          <form onSubmit={handleSubmit}>
            ...
            {/* Info Box - Replace role selection */}
            <div className="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
              <div className="flex items-start">
                ...
                <div className="text-sm">
                  <p className="text-blue-800 font-medium mb-1">Account Type</p>
                  <p className="text-blue-700">You'll start as a <strong>Property Seeker</strong>. If you're a property owner, an administrator can upgrade your account after verification.</p>
                </div>
              </div>
            </div>
